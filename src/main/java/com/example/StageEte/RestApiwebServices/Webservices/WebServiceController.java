...
public class WebServiceController {
    ...
    public WebServiceController(ClientRepository clientRepository, CommandeRepository commandeRepository,
    ...
    public ResponseEntity<Commande> createCommande(@PathVariable int id, @Valid @RequestBody CommandeRequest commande) {
        ...
        // Valider les identifiants des produits et récupérer les produits
        // correspondants
    ...
    // Permet de récupérer une commande spécifique d'un client par son identifiant
    ...
    private Commande retrieveCommandesForClient(@PathVariable int id, @PathVariable int id_cmd) {
        ...
        Commande commandes = listcommandes.get(id_cmd - 1);
        return commandes;
    }
